" flexoki_light.vim — vendored from Flexoki by Steph Ango (kepano),
" MIT licensed: https://github.com/kepano/flexoki/tree/main/vim
...
" Local tweak: same as CursorLine — drop the leftover cterm=underline, keep bold.
...
" Local tweak: s:Hi only sets gui colors, leaving the default cterm=underline,
" which renders as an underline on the current line even under termguicolors.
